...
const newProjects = [new Project("Footer html", 130), new Project("Contact form", 330), new Project("Main aside", 150), new Project("About us page", 430)];
...
// Emploees
const em = [new Emploee("Mike", "Mikson", 33, 15), new Emploee("Jill", "Jill", 30, 17), new Emploee("John", "Jill", 28, 20)];
